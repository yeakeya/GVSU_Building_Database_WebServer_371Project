...
describe("Building", () => {
    ...
    describe("#isValid", () => {
        ...
        it("rejects a nonexistent address", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", yearBuilt: 2008, area: 180000, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })

        it("rejects an address too long", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", yearBuilt: 2008, area: 180000, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })
        ...
        it("rejects a nonexistent year built", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", area: 180000, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })

        it("rejects a year before 0", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: -1, area: 180000, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })

        it("rejects a year after the current year", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: (new Date().getFullYear()) + 1, area: 180000, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })
        ...
        it("rejects a nonexistent area", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: 2008, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })

        it("rejects an area less than 0", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: 2008, area: -1, campus: "Allendale" })
            expect(testBuilding.isValid()).toBe(false)
        })
        ...
        it("passes Pew as a valid campus", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: 2008, area: 180000, campus: "Pew" })
            expect(testBuilding.isValid()).toBe(true)
        })

        it("passes Health as a valid campus", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: 2008, area: 180000, campus: "Health" })
            expect(testBuilding.isValid()).toBe(true)
        })

        it("rejects a nonexistent campus", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: 2008, area: 180000 })
            expect(testBuilding.isValid()).toBe(false)
        })

        it("rejects a false campus name", () => {
            let testBuilding = new Building({ name: "Niemeyer", abbreviation: "123456", description: "Test description!", address: "4045 Calder Dr.", yearBuilt: 2008, area: 180000, campus: "Downtown" })
            expect(testBuilding.isValid()).toBe(false)
        })
    })
})